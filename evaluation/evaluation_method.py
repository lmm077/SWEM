...
parser.add_argument('--year', type=str, help='Year of the dataset to be evaluated, [2016|2017]', default='2016')
...
parser.add_argument('--results_path', type=str, help='Path to the folder containing the sequences folders',
                    required=True)
parser.add_argument('--save_dir', type=str, help='Path to save the results', default='./save_results')
...
if os.path.exists(csv_name_global_path) and os.path.exists(csv_name_per_sequence_path):
    old_csv_name_global_path = os.path.join(args.results_path, f'old_{csv_name_global}')
    old_csv_name_per_sequence_path = os.path.join(args.results_path, f'old_{csv_name_per_sequence}')
    print(f'Rename precomputed results as {old_csv_name_global_path} and old_{old_csv_name_per_sequence_path}...')
